...
def create_model(inputs, targets, bounds):
    ...
    def mask_discriminator(inputs, masks):
        ...
        #layer 1 => [128 * 126 * 32]
        g_1 = discrim_conv(con_inputs, 32, 2, "m_1")
        layers.append(g_1)
        #layer 2 => [64 * 64 * 64]
        g_2 = discrim_conv(g_1, 64, 2, "m_2")
        layers.append(g_2)
        #layer 3 => [32 * 32 * 128]
        g_3 = discrim_conv(g_2, 128, 2, "m_3")
        layers.append(g_3)
        #layer 4 => [16 * 16 * 256]
        g_4 = discrim_conv(g_3, 512, 2, "m_4")
        layers.append(g_4)
        #layer 5 => [8 * 8 * 512]
        g_5 = discrim_conv(g_4, 512, 2, "m_5")
        layers.append(g_5)
        #layer 6 => [4, 4, 512]
        g_6 = discrim_conv(g_5, 512, 2, "m_6", function="sigmoid")
        layers.append(g_6)
        #layer 7 => [2, 2, 512]
